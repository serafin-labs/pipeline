...
export class TestPipe<M, RQ, RO, RM, CV, CO, CM, UV, UO, UM, PQ, PV, PO, PM, DQ, DO, DM> extends PipeAbstract {
    ...
    schemaBuilderCreateOptions = (s: SchemaBuilder<CO>) =>
        s.addString("testCreateOptionsString", { description: "testCreateOptionsString options description" })
    ...
    schemaBuilderReplaceOptions = (s: SchemaBuilder<UO>) =>
        s.addString("testReplaceOptionsString", { description: "testReplaceOptionsString options description" })
    ...
    schemaBuilderDeleteOptions = (s: SchemaBuilder<DO>) =>
        s.addString("testDeleteOptionsString", { description: "testDeleteOptionsString options description" })
